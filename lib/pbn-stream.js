...
var autoconvert = require('./auto-convert');
...
PbnStream.prototype._transform = function(line, encoding, done) {
    if (this.comment) {
        // LEO FIX 1 - the comment closing bracket was only getting picked up
        // if it was either on the first line (see line 129) or it was on it's
        // own line - line[0] === '}'
        ...
        if (name === 'Deal')
            ...
            if (value === 'Pass') {
                ...
                // LEO FIX 2 - added support for N contracts (N = NT)
                ...
                this.tag.denomination = contract[2];
